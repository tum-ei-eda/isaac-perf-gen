...
static SchedulingFunction *schedulingFunction_custom83 = new SchedulingFunction(
  CV32E40PXISAAC_SchedulingFunctionSet,
  "custom83",
  50,
  [](PerformanceModel* perfModel_){
...
// ID_stage
uint64_t n_ID_stage;
n_ID_stage = std::max({n_Decoder, n_uA_OF_A, n_uA_OF_B, perfModel->EX_stage, perfModel->EX_substage_CUSTOM83_I});
perfModel->ID_stage = n_ID_stage;
// CUSTOM83_I
uint64_t n_CUSTOM83_I;
n_CUSTOM83_I = n_ID_stage + 1;
// EX_substage_CUSTOM83_I
uint64_t n_EX_substage_CUSTOM83_I;
n_EX_substage_CUSTOM83_I = std::max({n_CUSTOM83_I, perfModel->EX_substage_CUSTOM83_X});
perfModel->EX_substage_CUSTOM83_I = n_EX_substage_CUSTOM83_I;
// CUSTOM83_X
uint64_t n_CUSTOM83_X = n_EX_substage_CUSTOM83_I;
// EX_substage_CUSTOM83_X
uint64_t n_EX_substage_CUSTOM83_X;
n_EX_substage_CUSTOM83_X = std::max({n_CUSTOM83_X, perfModel->EX_substage_CUSTOM83_O});
perfModel->EX_substage_CUSTOM83_X = n_EX_substage_CUSTOM83_X;
// CUSTOM83_O
uint64_t n_CUSTOM83_O = n_EX_substage_CUSTOM83_X;
perfModel->regModel.setXd(n_CUSTOM83_O);
// EX_stage
uint64_t n_EX_stage = n_CUSTOM83_O;
perfModel->EX_stage = n_EX_stage;
perfModel->EX_substage_CUSTOM83_O = n_EX_stage;
